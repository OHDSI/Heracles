        ...
        angular.element().ready(function() {
            ...
            angular.module('HeraclesAnalysis', []).controller('CohortExplorerCtrl', function($scope, $http) {
                ...
                $scope.visualizationPacks = {
                    ...
                    "Observation" : [800, 801, 806, 805, 815, 804, 802, 807, 117, 116, 1],
                    "Procedure" : [606, 604, 116, 602, 117, 605, 600,  601, 1],
                    "Visit" : [202, 206, 204, 116, 117, 211, 200, 201, 1],
                    "Cohort Specific" : [1800, 1801, 1802, 1803, 1804, 1805, 1806, 1814, 1815, 1820, 1830, 1831, 1870, 1871, 1821, 116, 117, 1],
                    "Measurement" : [1300, 1301, 1306, 1305, 1315, 1304, 1316, 1302, 1307, 1317, 1318, 117, 116, 1],
                    "Heracles Heel" : [
                        7,
                        8,
                        9,
